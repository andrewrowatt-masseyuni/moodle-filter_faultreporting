 ...
 *
 * No personal data is stored. Preset rows describe exemplar activities in a template course, and
 * the stored backups are of those exemplars, taken with user data excluded.
 *
